<div id="modalEditarContratista" class="" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="">
                    ...
                    <button disabled type="submit" class="btn btn-primary" name="btnEditarContratista" id="btnEditarContatista"> Enviar</button>
                </form>
            </div>
        </div>
    </div>
